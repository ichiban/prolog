...
var constants = map[internal.Atom]Number{
	atomPi: Float(math.Pi),
}

var unaryFunctors = map[internal.Atom]func(Number) (Number, error){
	atomMinus:               neg,
	atomAbs:                 abs,
	atomSign:                sign,
...
var binaryFunctors = map[internal.Atom]func(Number, Number) (Number, error){
	atomPlus:              add,
	atomMinus:             sub,
	atomAsterisk:          mul,
...
func eval(expression Term, env *internal.Env) (_ Number, err error) {
	defer func() {
...
func Is(vm *internal.VM, result, expression Term, k internal.Cont, env *internal.Env) *internal.Promise {
...
func Equal(_ *internal.VM, e1, e2 Term, k internal.Cont, env *internal.Env) *internal.Promise {
	ev1, err := eval(e1, env)
	if err != nil {
		return internal.Error(err)
	}
...
func NotEqual(_ *internal.VM, e1, e2 Term, k internal.Cont, env *internal.Env) *internal.Promise {
	ev1, err := eval(e1, env)
	if err != nil {
		return internal.Error(err)
	}
...
func LessThan(_ *internal.VM, e1, e2 Term, k internal.Cont, env *internal.Env) *internal.Promise {
	ev1, err := eval(e1, env)
	if err != nil {
		return internal.Error(err)
	}
...
func GreaterThan(_ *internal.VM, e1, e2 Term, k internal.Cont, env *internal.Env) *internal.Promise {
	ev1, err := eval(e1, env)
	if err != nil {
		return internal.Error(err)
	}
...
func LessThanOrEqual(_ *internal.VM, e1, e2 Term, k internal.Cont, env *internal.Env) *internal.Promise {
	ev1, err := eval(e1, env)
	if err != nil {
		return internal.Error(err)
	}
...
func GreaterThanOrEqual(_ *internal.VM, e1, e2 Term, k internal.Cont, env *internal.Env) *internal.Promise {
	ev1, err := eval(e1, env)
	if err != nil {
		return internal.Error(err)
	}
...
// asFloat returns x as internal.Float.
