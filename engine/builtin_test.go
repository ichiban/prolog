...
func TestIs(t *testing.T) {
	...
	t.Run("constant", func(t *testing.T) {
		t.Run("ok", func(t *testing.T) {
			ok, err := Is(&vm, Integer(1), NewAtom("foo"), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("undefined", func(t *testing.T) {
			_, err := Is(&vm, Integer(1), NewAtom("bar"), Success, nil).Force(context.Background())
			assert.Error(t, err)
		})
	})
	...
	t.Run("unary", func(t *testing.T) {
		t.Run("ok", func(t *testing.T) {
			ok, err := Is(&vm, Integer(1), NewAtom("foo").Apply(Integer(0)), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("undefined", func(t *testing.T) {
			_, err := Is(&vm, Integer(1), NewAtom("bar").Apply(Integer(0)), Success, nil).Force(context.Background())
			assert.Error(t, err)
		})

		t.Run("invalid argument", func(t *testing.T) {
			_, err := Is(&vm, Integer(1), NewAtom("foo").Apply(NewNamedVariable("X")), Success, nil).Force(context.Background())
			assert.Error(t, err)
		})

		t.Run("exceptional value", func(t *testing.T) {
			_, err := Is(&vm, Integer(1), NewAtom("undefined").Apply(Integer(0)), Success, nil).Force(context.Background())
			assert.Error(t, err)
		})
	})
	...
	t.Run("binary", func(t *testing.T) {
		t.Run("ok", func(t *testing.T) {
			ok, err := Is(&vm, Integer(1), NewAtom("foo").Apply(Integer(0), Integer(0)), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("undefined", func(t *testing.T) {
			_, err := Is(&vm, Integer(1), NewAtom("bar").Apply(Integer(0), Integer(0)), Success, nil).Force(context.Background())
			assert.Error(t, err)
		})

		t.Run("invalid argument", func(t *testing.T) {
			_, err := Is(&vm, Integer(1), NewAtom("foo").Apply(NewNamedVariable("X"), Integer(0)), Success, nil).Force(context.Background())
			assert.Error(t, err)
			_, err = Is(&vm, Integer(1), NewAtom("foo").Apply(Integer(0), NewNamedVariable("X")), Success, nil).Force(context.Background())
			assert.Error(t, err)
		})
	})

	t.Run("tertiary", func(t *testing.T) {
		_, err := Is(&vm, Integer(1), NewAtom("foo").Apply(Integer(0), Integer(0), Integer(0)), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("other", func(t *testing.T) {
		_, err := Is(&vm, Integer(1), &Stream{}, Success, nil).Force(context.Background())
		assert.Error(t, err)
	})
}
...
func TestNotEqual(t *testing.T) {
	...
	t.Run("integer", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := NotEqual(&vm, Integer(1), Integer(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := NotEqual(&vm, Integer(1), Float(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("float", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := NotEqual(&vm, Float(1), Integer(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := NotEqual(&vm, Float(1), Float(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("e1 is a variable", func(t *testing.T) {
		_, err := NotEqual(&vm, Integer(1), NewNamedVariable("X"), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("e2 is a variable", func(t *testing.T) {
		_, err := NotEqual(&vm, NewNamedVariable("X"), Integer(1), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("ng", func(t *testing.T) {
		ok, err := NotEqual(&vm, Integer(1), Integer(1), Success, nil).Force(context.Background())
		assert.NoError(t, err)
		assert.False(t, ok)
	})
}
...
func TestLessThan(t *testing.T) {
	...
	t.Run("integer", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := LessThan(&vm, Integer(1), Integer(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := LessThan(&vm, Integer(1), Float(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("float", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := LessThan(&vm, Float(1), Integer(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := LessThan(&vm, Float(1), Float(2), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("e1 is a variable", func(t *testing.T) {
		_, err := LessThan(&vm, Integer(1), NewNamedVariable("X"), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("e2 is a variable", func(t *testing.T) {
		_, err := LessThan(&vm, NewNamedVariable("X"), Integer(1), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("ng", func(t *testing.T) {
		ok, err := LessThan(&vm, Integer(1), Integer(1), Success, nil).Force(context.Background())
		assert.NoError(t, err)
		assert.False(t, ok)
	})
}
...
func TestLessThanOrEqual(t *testing.T) {
	...
	t.Run("integer", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := LessThanOrEqual(&vm, Integer(1), Integer(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := LessThanOrEqual(&vm, Integer(1), Float(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("float", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := LessThanOrEqual(&vm, Float(1), Integer(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := LessThanOrEqual(&vm, Float(1), Float(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("e1 is a variable", func(t *testing.T) {
		_, err := LessThanOrEqual(&vm, Integer(1), NewNamedVariable("X"), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("e2 is a variable", func(t *testing.T) {
		_, err := LessThanOrEqual(&vm, NewNamedVariable("X"), Integer(1), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("ng", func(t *testing.T) {
		ok, err := LessThanOrEqual(&vm, Integer(2), Integer(1), Success, nil).Force(context.Background())
		assert.NoError(t, err)
		assert.False(t, ok)
	})
}
...
func TestGreaterThan(t *testing.T) {
	...
	t.Run("integer", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := GreaterThan(&vm, Integer(2), Integer(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := GreaterThan(&vm, Integer(2), Float(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("float", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := GreaterThan(&vm, Float(2), Integer(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := GreaterThan(&vm, Float(2), Float(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("e1 is a variable", func(t *testing.T) {
		_, err := GreaterThan(&vm, Integer(1), NewNamedVariable("X"), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("e2 is a variable", func(t *testing.T) {
		_, err := GreaterThan(&vm, NewNamedVariable("X"), Integer(1), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("ng", func(t *testing.T) {
		ok, err := GreaterThan(&vm, Integer(1), Integer(1), Success, nil).Force(context.Background())
		assert.NoError(t, err)
		assert.False(t, ok)
	})
}
...
func TestGreaterThanOrEqual(t *testing.T) {
	...
	t.Run("integer", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := GreaterThanOrEqual(&vm, Integer(1), Integer(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := GreaterThanOrEqual(&vm, Integer(1), Float(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("float", func(t *testing.T) {
		t.Run("integer", func(t *testing.T) {
			ok, err := GreaterThanOrEqual(&vm, Float(1), Integer(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})

		t.Run("float", func(t *testing.T) {
			ok, err := GreaterThanOrEqual(&vm, Float(1), Float(1), Success, nil).Force(context.Background())
			assert.NoError(t, err)
			assert.True(t, ok)
		})
	})
	...
	t.Run("e1 is a variable", func(t *testing.T) {
		_, err := GreaterThanOrEqual(&vm, Integer(1), NewNamedVariable("X"), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("e2 is a variable", func(t *testing.T) {
		_, err := GreaterThanOrEqual(&vm, NewNamedVariable("X"), Integer(1), Success, nil).Force(context.Background())
		assert.Error(t, err)
	})

	t.Run("ng", func(t *testing.T) {
		ok, err := GreaterThanOrEqual(&vm, Integer(1), Integer(2), Success, nil).Force(context.Background())
		assert.NoError(t, err)
		assert.False(t, ok)
	})
}
...
func TestClause(t *testing.T) {
	...
	t.Run("the predicate indicator Pred of Head is that of a private (ie. Not public) procedure", func(t *testing.T) {
		...
		vm := VM{
			procedures: map[ProcedureIndicator]procedure{
				{Name: NewAtom("green"), Arity: 1}: Predicate1(func(*VM, Term, func(*Env) *Promise, *Env) *Promise {
					return Bool(true)
				}),
			},
		}
...
func TestOp(t *testing.T) {
	t.Run("insert", func(t *testing.T) {
		t.Run("atom", func(t *testing.T) {
			vm := VM{IO: IO{operators: operators{}}}
...
func TestNegation(t *testing.T) {
	...
	vm.Register0("false", func(_ *VM, k func(*Env) *Promise, env *Env) *Promise {
		return Bool(false)
	})
	vm.Register0("error", func(_ *VM, k func(*Env) *Promise, env *Env) *Promise {
		return Error(e)
	})
...
func TestSetPrologFlag(t *testing.T) {
	...
	t.Run("char_conversion", func(t *testing.T) {
		...
		t.Run("off", func(t *testing.T) {
			vm := VM{IO: IO{charConvEnabled: true}}
