...
func New(in io.Reader, out io.Writer) *Interpreter {
	...
	i.Register2(engine.NewAtom("is"), engine.DefaultEvaluableFunctors.Is)
	i.Register2(engine.NewAtom("=:="), engine.DefaultEvaluableFunctors.Equal)
	i.Register2(engine.NewAtom("=\\="), engine.DefaultEvaluableFunctors.NotEqual)
	i.Register2(engine.NewAtom("<"), engine.DefaultEvaluableFunctors.LessThan)
	i.Register2(engine.NewAtom(">"), engine.DefaultEvaluableFunctors.GreaterThan)
	i.Register2(engine.NewAtom("=<"), engine.DefaultEvaluableFunctors.LessThanOrEqual)
	i.Register2(engine.NewAtom(">="), engine.DefaultEvaluableFunctors.GreaterThanOrEqual)
