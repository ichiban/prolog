...
type DB interface {
	Insert(arena *term.Arena, record Record) error
	Select(arena *term.Arena, pi term.Functor, aliveAt wam.LogicalTime) iter.Seq2[Record, error]
	Delete(id int, deletedAt wam.LogicalTime) error
}
...
func (db *MemoryDB) Insert(arena *term.Arena, record Record) error {
...
func (db *MemoryDB) Select(arena *term.Arena, pi term.Functor, aliveAt wam.LogicalTime) iter.Seq2[Record, error] {
...
func (db *MemoryDB) Delete(id int, deletedAt wam.LogicalTime) error {
